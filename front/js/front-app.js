...
angular.module('ir-matrix-cooc', ['ngRoute', 'ngSanitize', 'nsPopover',
    ...
    .config(function ($routeProvider, $locationProvider, $translateProvider, localStorageServiceProvider) {
        ...
        $translateProvider.translations('en', {
            ...
            'SEC_COOC' : 'Cooccurrency',
            'SEC_COOC_TABLE' : 'Cooccurrency Table',
            ...
            'SEC_STATS_COOC' : 'Cooccurrency Statistics',
            'SEC_STATS_TITLEBOTH' : 'More frequent in {{corpus}}',
            'SEC_STATS_TITLEONLY' : 'Only in {{corpus}}',
            'SEC_STATS_WORD' : 'Word',
            'SEC_STATS_WORD1' : 'Word 1',
            'SEC_STATS_WORD2' : 'Word 2',
            'SEC_STATS_SIGNIFICANCE' : 'Significance',
            'SEC_STATS_POS' : 'POS',
            ...
            'SEC_WCONF_YEARS' : 'Year selection',
            'SEC_WCONF_DATETYPE' : 'by Days',
            ...
            'COOC_MIN_SIG' : 'least significance'
                ...
                'SEC_COOC' : 'Kookkurrenz',
                'SEC_COOC_TABLE' : 'Kookkurrenz Tabelle',
                'SEC_JOBS' : 'Jobauswahl',
                ...
                'SEC_STATS' : 'Statistik',
                'SEC_STATS_COOC' : 'Kookkurrenz Statistiken',
                'SEC_STATS_TITLEBOTH' : 'Häufiger in {{corpus}}',
                'SEC_STATS_TITLEONLY' : 'Nur in {{corpus}}',
                'SEC_STATS_WORD' : 'Wort',
                'SEC_STATS_WORD1' : 'Wort 1',
                'SEC_STATS_WORD2' : 'Wort 2',
                'SEC_STATS_SIGNIFICANCE' : 'Signifikanz',
                'SEC_STATS_POS' : 'POS',
                ...
                'SEC_WCONF_YEARS' : 'Jahresselektion',
                'SEC_WCONF_WORDS' : 'Wörter',
                'SEC_WCONF_DATETYPE' : 'nach Tagen',
